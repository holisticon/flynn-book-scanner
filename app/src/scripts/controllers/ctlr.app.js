...
app.controller('AppController', ['$scope', '$rootScope', '$log', '$state', '$window', '$ionicLoading', 'settingsService', 'inventoryService',
    function($scope, $rootScope, $log, $state, $window, $ionicLoading, settings, inventoryService) {
        ...
        $rootScope.$on('sync.remoteError', function(event) {
            showErrorDialog($rootScope, $scope, $ionicLoading, $log, 'Server error', 1004, 'Server doesn\'t respone with valid answer. Check server backend and/or remote URL.');
        });
