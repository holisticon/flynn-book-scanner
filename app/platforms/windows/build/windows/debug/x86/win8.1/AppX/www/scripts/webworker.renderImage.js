  ...
  return function e(t, n, r) {
    ...
    2: [function (e, t, n) {
      var r = "undefined" != typeof self ? self : "undefined" != typeof window ? window : {},
        o = "function" == typeof r.Promise ? r.Promise : e("lie");
      n.Promise = o
    }, {
      lie: 8
    }],
    3: [function (e, t) {
      ...
      var i = "undefined" != typeof self ? self : "undefined" != typeof window ? window : {},
        u = i.BlobBuilder || i.WebKitBlobBuilder || i.MSBlobBuilder || i.MozBlobBuilder,
        a = function () {
          try {
            var e = new Blob(["hi"]);
            return 2 === e.size
    ...
    13: [function (e, t) {
      ...
      var r = e("./promise"),
        ...
        i = e("./handlers");
      t.exports = n;
      var u = i.resolve(new r(o), !1),
        a = i.resolve(new r(o), null),
        s = i.resolve(new r(o), void 0),
        f = i.resolve(new r(o), 0),
        c = i.resolve(new r(o), "")
    }, {
      "./INTERNAL": 5,
      "./handlers": 7,
    ...
    18: [function (e, t) {
      ...
      for (var o, i, u = [e("./nextTick"), e("./mutation.js"), e("./messageChannel"), e("./stateChange"), e("./timeout")], a = [], s = -1, f = u.length; ++s < f;)
        if (u[s] && u[s].test && u[s].test()) {
          i = u[s].install(n);
          break
        }
      t.exports = r
...
// worker.js
this.onmessage = function (msgData) {
  var image = msgData.data;
