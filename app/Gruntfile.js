...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    buildAPK: {
      command: 'cp "$(pwd)/platforms/android/build/outputs/apk/android-armv7-release-unsigned.apk" "$(pwd)/target/Flynn_armv7<%= app.version %>.apk && cp "$(pwd)/platforms/android/build/outputs/apk/android-x86-release-unsigned.apk" "$(pwd)/target/Flynn_x86<%= app.version %>.apk"'
    }
	},
    concurrent: {
      server: [
